...
public class BookServiceImpl implements BookService {
    ...
    @Override
    public List<String> findAllfindAllBooksTitlesByGoldEditionAndHaveLessThan() {
    ...
    @Override
    public List<String> findAllBookTitlesByPriceLowerThan4OrGreaterThan40() {
    ...
    @Override
    public List<String> findAllTitlesEditionTypesAndPricesReleasedBeforeDate(LocalDate localDate) {
    ...
    @Override
    public List<String> findAllBooksTitlesWhichContainGivenString(String str) {
    ...
    @Override
    public List<String> findAllBookTitlesAndAuthorByGivenString(String str) {
    ...
    @Override
    public int findAllBookTitlesLongerThanNum(int num) {
      return bookRepository.countOfBooksByTitleLongerThanGivenInteger(num);


    }

    @Override
    public List<String> findBookByGivenTitle(String title) {
        return    bookRepository.findAllByTitle(title)
                   .stream().map(book -> String.format("%s %s %s %.2f",book.getTitle()
